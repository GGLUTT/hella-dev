...
export default function AIAutomation() {
  ...
  return (
    <section id="automation" className="relative overflow-hidden bg-black py-24 sm:py-32">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -right-32 top-1/4 h-[350px] w-[350px] rounded-full bg-fuchsia-500/[0.04] blur-[100px] md:h-[650px] md:w-[650px] md:blur-[160px] z-0"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute -left-32 bottom-1/4 h-[350px] w-[350px] rounded-full bg-teal-500/[0.04] blur-[100px] md:h-[650px] md:w-[650px] md:blur-[160px] z-0"
      />
